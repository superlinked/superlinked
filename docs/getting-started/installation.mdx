---
title: "Installation"
description: "Install and set up Superlinked in your environment"
icon: display
---

<Tabs>
<Tab title="In a notebook" icon="book">
...
<Tab title="As a script" icon="terminal">
...
```python Example.py icon="python" expandable
import json
import os
