...
- Improve redis connection reliability with keepalive and health checks
...
- Improve modal async batching and fix configuration

## [37.2.0] - 2025-09-08

### Added

- Add salt parameter to enable identical spaces with different weights
